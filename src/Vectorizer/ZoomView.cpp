...
/*---------------------------------------------------------------------------
   FUNCTION: ZoomView
   PURPOSE : Constructor for the ZoomView class
---------------------------------------------------------------------------*/
ZoomView::ZoomView()
        : CScrollView()
{
  ...
  m_hZoomCursor = ::LoadCursor(AfxGetInstanceHandle(), MAKEINTRESOURCE(IDC_ZOOM));
...
/*---------------------------------------------------------------------------
   FUNCTION: ~ZoomView
   PURPOSE : Destructor for the ZoomView class
---------------------------------------------------------------------------*/
ZoomView::~ZoomView()
{
...
/////////////////////////////////////////////////////////////////////////////
// ZoomView overridden default CScrollView members
/////////////////////////////////////////////////////////////////////////////

/*---------------------------------------------------------------------------
   FUNCTION: SetZoomSizes
   PURPOSE : Set up the ZoomView class with the logical page size, and
         scrolling page/line units.
         This replaces CScrollView::SetScrollSizes.
---------------------------------------------------------------------------*/
void ZoomView::SetZoomSizes (
    SIZE sizeTotal,
...
/////////////////////////////////////////////////////////////////////////////
// ZoomView custom members to implement zooming functionality
/////////////////////////////////////////////////////////////////////////////
...
---------------------------------------------------------------------------*/
void ZoomView::CenterOnLogicalPoint(CPoint pt)
{
...
---------------------------------------------------------------------------*/
CPoint ZoomView::GetLogicalCenterPoint (void)  // Point in logical units
{
  CPoint pt;
  CRect rect;
...
---------------------------------------------------------------------------*/
void ZoomView::OnMouseMove(UINT nFlags, CPoint point)
{
  // Pass the message along
...
---------------------------------------------------------------------------*/
void ZoomView::OnRButtonDown(UINT nFlags, CPoint point)
{
...
---------------------------------------------------------------------------*/
BOOL ZoomView::OnSetCursor(CWnd* pWnd, UINT nHitTest, UINT message)
{
...
void ZoomView::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	...
	if(nChar==107){this->DoZoomIn();return;}
	if(nChar==109){this->DoZoomOut();return;}
